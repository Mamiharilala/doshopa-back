...
<div class="pd-20 card-box mb-30">
	...
	<div class="wizard-content">
		<form class="tab-wizard wizard-circle wizard vertical" action="${pageContext.request.contextPath}/boutique/treat/treatBoutique.jsp">
			...
			<input type="hidden" class="form-control" value="${pageContext.request.contextPath}/container.jsp?content=boutique/boutique_affectation_code_collecter.jsp" name="after">
