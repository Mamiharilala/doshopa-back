...
<div class="pd-20 card-box mb-30">
	<form action="${pageContext.request.contextPath}/oadmin/treat.jsp"
		...
		<br>
		<div class="nav justify-content-center">
			<a href="${pageContext.request.contextPath}/oadmin/container.jsp?content=boutique/boutique_commande_mere_fille_update.jsp&idMere=<%=request.getParameter("id")%>"><button type="button" class="btn btn-success">Voir détail</button>
		</div>
	</form>
	<br>
</div>
