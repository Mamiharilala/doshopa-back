...
<div class="pd-20 card-box mb-30">
	<form action="${pageContext.request.contextPath}/oadmin/treat.jsp"
		...
		<input type="hidden" class="form-control"
			value="${pageContext.request.contextPath}/oadmin/container.jsp?content=profil/user_detail.jsp"
		...
		<br>
		<div class="nav justify-content-center">
			<a href="${pageContext.request.contextPath}/oadmin/container.jsp?content=profil/user_detail.jsp&id=<%=request.getParameter("id")%>"><button type="button" class="btn btn-warning">Voir détail</button>
		</div>
