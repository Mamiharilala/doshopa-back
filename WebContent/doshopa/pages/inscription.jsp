                        ...
                        <div class=" card-registration my-4">
                            <div class="row g-0">
                                <div class="col-xl-6 d-none d-xl-block">
                                    <img src="${pageContext.request.contextPath}/doshopa/assets/images/inscription-image.jpg"
                                ...
                                <div class="col-xl-6">
                                    <div class="card-body p-md-5 text-black">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-4">
                                                <div class="form-outline">
                                                    <label class="form-label" for="form3Example1n1">Nouveau mot de
                                                        passe</label>
                                                    <input name="mot_passe" type="password" id="form3Example1n1"
                                                        class="form-control form-control-lg btn-sm" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <p class="mb-1 pb-lg-2" style="color: #393f81;">Déjà fait une inscription? <a
                                                href="<?php echo base_url('auth/login');?>" style="color: #393f81;">Se
                                                connecter</a></p>
                                        <a href="#!" class="small text-muted">Terms of use.</a>
                                        <a href="#!" class="small text-muted">Privacy policy</a>
                                        <div class="d-flex justify-content-end pt-2">
                                            <button type="button" class="btn btn-warning btn-lg ms-2 text-light btn-sm">
                                                Réinitialiser
                                            </button>
                                            <button type="submit"
                                                class="btn btn-dark btn-lg ms-2 btn-sm">S'inscrire</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
